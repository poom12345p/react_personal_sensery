...
`;function Pe(t,r,e){switch(e){case"bottom-left":return r?xe:ae;case"bottom-right":return r?we:ne;case"down":return t?r?$e:oe:r?Se:se;case"left":return t?r?Oe:ie:r?Ce:vt;case"right":return t?r?Re:fe:r?Ee:ce;case"top-left":return r?Ie:de;case"top-right":return r?Ae:le;case"up":return t?r?Te:me:r?Ne:ue;default:return r?ve:ee}}const Me=t=>{const{big:r=!1,direction:e,reverse:a=!1,...n}=t,s=E.useMemo(()=>Pe(r,a,e),[r,e,a]);return A(Qt,{keyframes:s,...n})};o`
  from {
...
`;export{Me as F,qt as T,Ft as g,Vt as i,$r as m,gt as r,bt as s,Dt as u,Wt as w};
